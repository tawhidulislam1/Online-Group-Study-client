...
const Faq = () => {
    return (
        <div className="my-12">
            <h2 className="text-5xl font-bold text-black text-center mb-10">FAQ & Rules</h2>

            <div className="collapse collapse-arrow bg-base-200">
                <input type="radio" name="my-accordion-2" />
                <div className="collapse-title text-xl font-medium">What is Study Together? What is it for and what can I do here?</div>
            ...
            <div className="collapse collapse-arrow bg-base-200">
                <input type="radio" name="my-accordion-2" />
                <div className="collapse-title text-xl font-medium">Do I need to study a specific subject or go to a specific school?</div>
                <div className="collapse-content">
            ...
            <div className="collapse collapse-arrow bg-base-200">
                <input type="radio" name="my-accordion-2" />
                <div className="collapse-title text-xl font-medium">I would like to join. How do I do that?</div>
                <div className="collapse-content">
            ...
            <div className="collapse collapse-arrow bg-base-200">
                <input type="radio" name="my-accordion-2" />
                <div className="collapse-title text-xl font-medium">Are there any regular events or rooms for group discussions, etc?</div>
                <div className="collapse-content">
            ...
            <div className="collapse collapse-arrow bg-base-200">
                <input type="radio" name="my-accordion-2" />
                <div className="collapse-title text-xl font-medium">Who is behind Study Together and what are you trying to accomplish?</div>
                <div className="collapse-content">
